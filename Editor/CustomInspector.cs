...
namespace Anatawa12.lilToonVAT
{
    public class lilToonVATInspector : lilToonInspector
    {
        // Custom properties
        MaterialProperty isMock;
        ...
        private const string shaderName = "lilToonVAT";
        ...
        protected override void LoadCustomProperties(MaterialProperty[] props, Material material)
        {
            ...
            //LoadCustomLanguage("");
            isMock = FindProperty("_IsFluid", props);
        ...
        protected override void DrawCustomProperties(Material material)
        {
            ...
            if(isShowCustomProperties)
            {
                ...
                m_MaterialEditor.TexturePropertySingleLine(new GUIContent("Position Texture"), posTexture);
                ...
                m_MaterialEditor.ShaderProperty(motion, "Motion");
                EditorGUI.EndDisabledGroup();

                EditorGUI.BeginDisabledGroup(timeMotion.floatValue == 0);
                m_MaterialEditor.ShaderProperty(fps, "FPS");
                EditorGUI.EndDisabledGroup();
